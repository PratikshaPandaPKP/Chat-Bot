...
class ChatBot:
    ...
    def main_window(self):
        ...
        self.tab.add(self.bot_frame, text='PratikshaPandaBot'.center(100))
    ...
    def add_bot(self):
        ...
        head_label = Label(self.bot_frame, bg=BG_COLOR, fg=TEXT_COLOR, text="Welcome to PKPBot", font=FONT_BOLD,
                           pady=10)
